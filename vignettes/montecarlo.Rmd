...
## Hourly Shaping
```{r, setup fwds}
dt_fwd_prep_pwr = merge(dt_fwd_pwr, eikondata::generate_monthrics_pwr('Greece', time_range = 2024), by.x = 'yymm', by.y ='date', all.x = TRUE) 
dt_fwd_prep_gas = merge(dt_fwd_gas, eikondata::generate_monthrics_gas('TFMB', time_range = 2024), by.x = 'yymm', by.y ='date', all.x = TRUE) 

...
#
# #apply daily filter to hourly df
# history_1st_filter = history_w_breaks[filtered_dam_dd, on = "date"]
#
# filter_outlier_hourly=function(dataframe,smp_name){
#
#   # check formati
...
# }
#
# pp=filter_outlier_hourly(history_1st_filter,'smp')
# saveRDS(pp, file = file.path('..', 'HPFC','data', 'data_package', "filtered_dam_ddhh.rds"))

...
# history_w_breaks=readRDS(file = file.path('..', 'HPFC','data', 'data_package', "history_w_breaks.rds"))
#
# filter_outlier_daily=function(dataframe,smp_name){
#
#   # check formati
...
#   df_dam_day[, out_values := fifelse(out_dummy == 1, smp_day, NA_real_)]
#
#   filtered_dam_dd = df_dam_day[out_dummy == 0, .(date, smp_day)]
#
#   return(filtered_dam_dd)
#
# }
#
# p=filter_outlier_daily(history_w_breaks,'smp')
#
# saveRDS(p, file = file.path('..', 'HPFC','data', 'data_package', "filtered_dam_dd.rds"))

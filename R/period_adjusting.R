...
#
# calendar_hourly=readRDS(file = file.path('..', 'HPFC','data', 'data_package', "calendar_hourly.rds"))
#
# period_adjusting=function(dataframe,last_date){
#
#   if (!('forward_month_BL' %in% colnames(dataframe)) | class(dataframe$forward_month_BL) != 'numeric') {stop("forward_month_BL column must be format numeric")
...
# }
#
# f5=period_adjusting(calendar_hourly,'2023-01-09')
# saveRDS(f5, file = file.path('..', 'HPFC','data', 'data_package', "calendar_hourly_adjusted.rds"))

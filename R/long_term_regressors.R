...
# filtered_dam_dd_detrended=readRDS(file = file.path('..', 'HPFC','data', 'data_package', "filtered_dam_dd_detrended.rds"))
#
# long_term_regressor=function(dataframe,alpha){
#
#   # check formati
...
# }
#
# p4=long_term_regressor(filtered_dam_dd_detrended,0.4)
#
# saveRDS(p4, file = file.path('..', 'HPFC','data', 'data_package', "dd_wregressor.rds"))

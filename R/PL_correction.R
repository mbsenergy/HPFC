...
# dd_Leu_spline=readRDS(file = file.path('..', 'HPFC','data', 'data_package', "dd_Leu_spline.rds"))
#
# PL_correction=function(dataframe){
#
#   if (!('L_e_u_adj' %in% colnames(dataframe)) | class(dataframe$L_e_u_adj) != 'numeric') {stop("L_e_u_adj column must be format numeric")}
...
# }
#
# f8=PL_correction(dd_Leu_spline)
# saveRDS(f8, file = file.path('..', 'HPFC','data', 'data_package', "dd_final.rds"))
#
